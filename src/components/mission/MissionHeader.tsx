...
const riskColor =
  ...
  Operational mission generated by integrating climate observations,
  satellite evidence, AI-based risk assessment, and decision
  intelligence to support coordinated early action across the
  Horn of Africa.
</p>
        </div>
