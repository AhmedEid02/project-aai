  ...
  return (
    <section className="rounded-3xl border border-slate-800 bg-slate-950 p-5">
      ...
      <p className="mt-2 text-sm leading-6 text-slate-300">
        ARIE links decisions to expected operational outcomes so early action can
        be judged by coordination, targeting, and last-mile uptake — not only by
        warning issuance.
      </p>
        ...
        {outcomes.map((outcome) => (
          ...
          >
            <div className="flex items-start justify-between gap-4">
              ...
              <span className="shrink-0 rounded-full bg-cyan-400/10 px-2.5 py-1 text-xs font-semibold text-cyan-200">
                {outcome.value}
              </span>
            </div>
          </article>
